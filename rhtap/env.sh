...
export IMAGE_URL=rhtap-quay-quay-rhtap-quay.apps.rhopp240809.devcluster.openshift.com/rhtap/goapp:jenkins-$TAG
...
export GITOPS_REPO_URL=https://github.com/rhopp-rhtap-testing/goapp-gh-jenkins240809-gitops
